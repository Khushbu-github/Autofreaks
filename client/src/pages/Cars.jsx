            ...
            {filteredCars.length === 0 ? (
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
                    {filteredCars.map((car, index) => (
                        <div key={car.id} className="group bg-gray-900/40 backdrop-blur rounded-2xl shadow-lg border border-gray-800 overflow-hidden hover:shadow-white/5 hover:border-gray-600 transition-all duration-300" data-aos="fade-up" data-aos-delay={index * 50}>
                            ...
                            <div className="p-5 sm:p-6">
                                ...
                                <p className="text-xl sm:text-2xl font-bold text-gray-100 mb-5 sm:mb-6">{car.price ? `₹ ${car.price.toLocaleString()}` : 'Contact for Price'}</p>
                                <Link
                                    to={`/cars/${car.id}`}
